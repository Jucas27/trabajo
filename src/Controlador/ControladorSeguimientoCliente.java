...
public void actionPerformed(ActionEvent e) {
       ...
       JOptionPane.showMessageDialog(null, leyenda);//Se manda mensaje con elresultado de la
        ...
        if (e.getSource()==_view.cmdAlta){
         // System.out.print("paso");
         //En estas linea se toman los valores puestos en el formulario, para llevarlos a la base de datos.
        leyenda=_model.registrarAlta("seguimiento_clientes"," null, ' " +_view.txtEmail.getText()+" ',' " +_view.txtTel_Residencia.getText() +" ', "
                + ""+_view.Tel_Trabajo.getText()+" ',' " +_view.txtNum_Factura.getText()+" ',' " +_view.txtTipo_Cartera.getText()+" ',' " +_view.txtFecha_Mora.getText()+" ',' "
